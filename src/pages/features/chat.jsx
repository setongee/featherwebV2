...
import feature from '../../assets/photos/chatty.png'
import withdrawIcon from '../../assets/icons/withdraw_icon.svg'
import WithImg from '../../assets/photos/chatsComplex.png'
    ...
    <div className="featurePage">
        ...
        <Guide>
            ...
            <div className="featureHere">
                ...
                <div className="tops"> <img src={withdrawIcon} alt="" />  Features <span>//</span> <strong>chats</strong> </div>

                <div className="feat">

                    <div className="title"> 
                    
                        <div className="main">Chat with other feather users and merchants for free.</div>
